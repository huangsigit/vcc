...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public boolean updateUser(User user) {
        ...
        if (result && user.getRoleIds() != null) {
            if(user.getWarningAmount() == null){
                userMapper.updateWarningAmount(user.getUserId(), user.getWarningAmount());
            }
    ...
    @Override
    public void updateWarningAmount(Integer user_id, BigDecimal warningAmount){
        userMapper.updateWarningAmount(user_id, warningAmount);
