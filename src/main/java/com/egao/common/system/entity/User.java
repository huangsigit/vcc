...
//        groupStatus == null ? 0 : groupStatus;
    ...
    public void setWarningAmount(BigDecimal warningAmount) {
        System.out.println("setwarningAmount:"+warningAmount);
        System.out.println("this.warningAmount:"+this.warningAmount);
        System.out.println("warningAmount:"+getWarningAmount());
