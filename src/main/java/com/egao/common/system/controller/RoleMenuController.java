...
public class RoleMenuController extends BaseController {
    ...
    public JsonResult list(Integer roleId) {
        ...
        System.out.println("角色管理 roleId："+ roleId);
        System.out.println("角色管理 menus："+ JSONObject.toJSON(menus));
        System.out.println("角色管理 roleMenus："+ JSONObject.toJSON(roleMenus));
        ...
        System.out.println("角色管理 menus2："+ JSONObject.toJSON(menus));
